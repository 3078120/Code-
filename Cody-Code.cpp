...
int main()
{
	...
	if (wage1 <= 11000){ // the if statement triggers if you only earn 11000 pounds or under and then prints out you dont have to pay any income tax.//
		...
		cout << "You pay 20 percent tax this how much you pay:  \n " << tax1 << endl; //prints out that you pay 20 percent tax and shows you how much tax you pay//
		cout << "This is how much you make in a year after tax: \n" << total << endl;// prints out how much you keep after tax a year//
	}
		...
		cout << " You pay 40 percent tax this how much you pay: \n" << tax3 << endl; // prints out that you pay 40 percent tax and shows you how much you pay//
		cout << "This is how much you make in a year after tax:  \n" << total << endl; // prints your total amount of money after tax//
	}
		...
		HighTax = (wage1 - 150000);// the highest amount tax you pay which is 45 percent - your wage //
		tax1 = HighTax / 100 * 45;
		tax2 = 118000 / 100 *40;
		tax3 = 32000 / 100 * 20;
		total = tax1 + tax2 + tax3;
		total2 = wage1 - total; // works how much you have after tax each year //
